warn("  Copy/skid list:")
warn("    thienngoan")
warn(" Sklans (makram12345)")
warn("Black_Samurai (siver1725)")

game.StarterGui:SetCore("SendNotification",  {
	Title = "Smug Notification";
	Text = "DRIPPERS!1!!1!#6196, LighTMolT#1080";
	Icon = "rbxthumb://type=Asset&id=7270904412&w=150&h=150"})
...
game.StarterGui:SetCore("SendNotification",  {
	Title = "Smug Notification";
	Text = "Sexy Neko Remake Loaded, Enjoy! ;o";
	Icon = "rbxthumb://type=Asset&id=7270904412&w=150&h=150"})
...
addmode("default", {
	idle = function()
		local rY, lY = raycastlegs()
		    RightShoulder.C0=RightShoulder.C0:Lerp(cf(1,0.6,0.5)*angles(-1.0471975511965976,2.792526803190927,0.8726646259971648),deltaTime) 
		    LeftShoulder.C0=LeftShoulder.C0:Lerp(cf(-1,0.7,0.5)*angles(-1.2217304763960306,-2.792526803190927,-0.8726646259971648),deltaTime) 
			...
			RightHip.C0 = RightHip.C0:Lerp(cf(1, -1.2 - 0.1 * sin(sine * 2) + rY, 0.1 * sin(sine * 2) - rY * 0.5) * angles(-0.6981317007977318 - 0.08726646259971647 * sin(sine * 2), 2.0471975511965976, 0.5235987755982988), deltaTime)
			LeftHip.C0 = LeftHip.C0:Lerp(cf(-1, -1.1 - 0.1 * sin(sine * 2) + lY, 0.1 * sin(sine * 2) - lY * 0.5) * angles(-0.3490658503988659 - 0.08726646259971647 * sin(sine * 2), -2.0471975511965976, -0.5235987755982988), deltaTime)
end,	
walk = function()
...
fall = function()
	local fw, rt = velbycfrvec()
			...
			RightHip.C0 = RightHip.C0:Lerp(cf(1, -1, 0) * angles(1.5707963267948966 - 0.08726646259971647 * sin((sine + 0.5) * 4), 1.6580627893946132 - 0.06981317007977318 * sin((sine + 0.25) * 4), -1.5707963267948966), deltaTime)	--Torso,0,0,0,4,-95,0,0,4,0,0,0,4,0,0,0,4,0,0,0,4,-180,0,0,4,RightArm,1,0,0,4,230,-5,0.5,4,0.5,0,0,4,100,5,0.25,4,0,0,0,4,-90,0,0,4,LeftLeg,-1,0,0,4,90,-5,0.5,4,-1,0,0,4,-95,4,0.25,4,0,0,0,4,90,0,0,4,LeftArm,-1,0,0,4,230,-5,0.5,4,0.5,0,0,4,-100,-5,0.25,4,0,0,0,4,90,0,0,4,Head,0,0,0,4,-100,0,0.5,4,1,0,0,4,0,0,0.25,4,0,0,0,4,-180,0,0,4,RightLeg,1,0,0,4,90,-5,0.5,4,-1,0,0,4,95,-4,0.25,4,0,0,0,4,-90,0,0,4
end
})

addmode("g", {
		idle = function()
			RootJoint.C0=RootJoint.C0:Lerp(cf(0,-0.4,0)*angles(-2.443460952792061+0.08726646259971647*sin(sine*3),0,3.141592653589793),deltaTime) 
                  LeftHip.C0=LeftHip.C0:Lerp(cf(-1,-1,0)*angles(0.08726646259971647*sin(sine*-3),-1.2217304763960306+0.08726646259971647                         *sin(sine*-3),-0.8726646259971648),deltaTime) 
                  LeftShoulder.C0=LeftShoulder.C0:Lerp(cf(-0.8,0.5,0)*angles(0.05235987755982989*sin(sine*3),-2.0943951023931953,-0.5235987755982988),deltaTime) 
                  Neck.C0=Neck.C0:Lerp(cf(0,1,0)*angles(-0.6981317007977318+0.17453292519943295*sin(sine*2),0.03490658503988659*sin(sine*3),3.141592653589793),deltaTime) 
                  RightShoulder.C0=RightShoulder.C0:Lerp(cf(0.8,0.5,0)*angles(0.05235987755982989*sin(sine*3),2.0943951023931953,0.5235987755982988),deltaTime) 
                  RightHip.C0=RightHip.C0:Lerp(cf(1,-1,0)*angles(0.08726646259971647*sin(sine*-3),1.2217304763960306+0.08726646259971647*sin(sine*3),0.8726646259971648),deltaTime) 
	end
})

addmode("h", {
		idle = function()
			RightShoulder.C0=RightShoulder.C0:Lerp(cf(1,0.5,0.1 * sin(sine*2))*angles(-1.2217304763960306,1.5707963267948966,0.017453292519943295*sin(sine*3)),deltaTime) 
            RightHip.C0=RightHip.C0:Lerp(cf(0.4,-1.5,0.3)*angles(1.3962634015954636,31.41592653589793,0.6981317007977318+0.05235987755982989*sin(sine*1)),deltaTime) 
            LeftHip.C0=LeftHip.C0:Lerp(cf(-0.4,-1.5,0.3)*angles(1.3962634015954636,-31.41592653589793,-0.6981317007977318+0.05235987755982989*sin(sine*-1)),deltaTime) 
            LeftShoulder.C0=LeftShoulder.C0:Lerp(cf(-1,0.5,0.1 * sin(sine*2))*angles(-1.2217304763960306,-1.5707963267948966,0.017453292519943295*sin(sine*3)),deltaTime) 
            RootJoint.C0=RootJoint.C0:Lerp(cf(0,-2,0.1 * sin(sine*1))*angles(-0.5235987755982988,0,3.141592653589793),deltaTime) 
            Neck.C0=Neck.C0:Lerp(cf(0,1,0)*angles(-2.2689280275926285+0.05235987755982989*sin(sine*2),0.03490658503988659*sin(sine*1),3.141592653589793),deltaTime) 
	end
})

addmode("j", {
		idle = function()
			LeftShoulder.C0=LeftShoulder.C0:Lerp(cf(-1.2,-0.1,-0.2)*angles(1.8325957145940461+0.017453292519943295*sin(sine*9),-3.141592653589793,-0.5235987755982988),deltaTime) 
            RightHip.C0=RightHip.C0:Lerp(cf(0.5,-1.5,-0.3)*angles(-1.4835298641951802,-3.141592653589793+0.017453292519943295*sin(sine*2),-0.08726646259971647+0.017453292519943295*sin(sine*3)),deltaTime) 
            RootJoint.C0=RootJoint.C0:Lerp(cf(0,-1.7,0)*angles(-1.6580627893946132,0,3.141592653589793),deltaTime) 
            LeftHip.C0=LeftHip.C0:Lerp(cf(-0.5,-1.5,-0.3)*angles(-1.4835298641951802,-3.141592653589793+0.017453292519943295*sin(sine*2),0.08726646259971647+0.017453292519943295*sin(sine*-3)),deltaTime) 
            Neck.C0=Neck.C0:Lerp(cf(0,0.9,-0.1 * sin(sine*8))*angles(-1.5707963267948966+0.08726646259971647*sin(sine*-8),0,3.141592653589793),deltaTime) 
            RightShoulder.C0=RightShoulder.C0:Lerp(cf(1.2,-0.1,-0.2)*angles(1.8325957145940461+0.017453292519943295*sin(sine*9),3.141592653589793,0.5235987755982988),deltaTime) 
	end
})

addmode("r", {
	idle = function()
	RightHip.C0=RightHip.C0:Lerp(cf(0.5,-1,-0.5)*angles(-0.5235987755982988+0.5235987755982988*sin(sine*5),3.141592653589793,-0.17453292519943295),deltaTime) 
        RootJoint.C0=RootJoint.C0:Lerp(cf(0,-2.5,0)*angles(-3.141592653589793,0,3.141592653589793),deltaTime) 
        LeftShoulder.C0=LeftShoulder.C0:Lerp(cf(-1,1.5,0)*angles(4.537856055185257,-3.141592653589793,-0.3490658503988659+0.17453292519943295*sin(sine*-4)),deltaTime) 
        LeftHip.C0=LeftHip.C0:Lerp(cf(-0.5,-1,-0.5)*angles(-0.5235987755982988+0.5235987755982988*sin(sine*-5),-3.141592653589793,0.17453292519943295),deltaTime) 
        Neck.C0=Neck.C0:Lerp(cf(0,1.2,0.5)*angles(-0.17453292519943295,0.3490658503988659*sin(sine*4),3.141592653589793),deltaTime) 
        RightShoulder.C0=RightShoulder.C0:Lerp(cf(1,1.5,0)*angles(4.537856055185257,3.141592653589793,0.3490658503988659+0.17453292519943295*sin(sine*-4)),deltaTime) 
	end
})

addmode("t", {
	idle = function()
RightShoulder.C0=RightShoulder.C0:Lerp(cf(1.3,0.5,-1.5)*angles(0,-0.3490658503988659,-2.007128639793479-0.08726646259971647*sin(sine*10)),deltaTime) 
LeftShoulder.C0=LeftShoulder.C0:Lerp(cf(-1.5,0.5,-0.5)*angles(0,0,-0.08726646259971647),deltaTime) 
Neck.C0=Neck.C0:Lerp(cf(0,1,0)*angles(-1.3962634015954636+0.3490658503988659*sin(sine*10),0,3.141592653589793),deltaTime) 
RootJoint.C0=RootJoint.C0:Lerp(cf(0,0,0)*angles(-1.5707963267948966,0,3.141592653589793),deltaTime) 
LeftHip.C0=LeftHip.C0:Lerp(cf(-0.5,-1,0.5)*angles(0,0,-0.17453292519943295),deltaTime) 
RightHip.C0=RightHip.C0:Lerp(cf(0.5,-1,0.5)*angles(0,0,0.17453292519943295),deltaTime) 
	end
})

addmode("u", {
	idle = function()
LeftHip.C0=LeftHip.C0:Lerp(cf(-0.5,-1.1,0.6)*angles(0,0,-0.17453292519943295-0.017453292519943295*sin(sine*3)),deltaTime) 
Neck.C0=Neck.C0:Lerp(cf(0,1-0.1*sin(sine*3),0)*angles(-1.5707963267948966,0,3.141592653589793),deltaTime) 
LeftShoulder.C0=LeftShoulder.C0:Lerp(cf(-0.8,2.3,-0.4)*angles(0,0.17453292519943295,-0.2617993877991494),deltaTime) 
RightHip.C0=RightHip.C0:Lerp(cf(0.5,-1,0.5)*angles(0,0,-0.17453292519943295-0.017453292519943295*sin(sine*3)),deltaTime) 
RightShoulder.C0=RightShoulder.C0:Lerp(cf(1.3,0.4,-0.5)*angles(0,-1.0471975511965976,-1.5707963267948966),deltaTime) 
RootJoint.C0=RootJoint.C0:Lerp(cf(0,-2,0)*angles(-1.5707963267948966,-1.5707963267948966,-2.8797932657906435),deltaTime) 
	end
})
...
Neck.C0=Neck.C0:Lerp(cf(-0.1 * sin(sine*100),1-0.1*sin(sine*100),0)*angles(-1.5707963267948966,0,3.141592653589793),deltaTime) 
LeftShoulder.C0=LeftShoulder.C0:Lerp(cf(-0.9-0.1*sin(sine*1000),0.5-0.1*sin(sine*1000),-1)*angles(0,0,2.6179938779914944),deltaTime) 
LeftHip.C0=LeftHip.C0:Lerp(cf(-0.5,-1.1,0.5)*angles(0,0,-0.17453292519943295),deltaTime) 
RightHip.C0=RightHip.C0:Lerp(cf(0.5,-1.2,0.5)*angles(0.17453292519943295,0,0.17453292519943295),deltaTime) 
RightShoulder.C0=RightShoulder.C0:Lerp(cf(0.9-0.1*sin(sine*1000),0.5-0.1*sin(sine*1000),-1)*angles(0,0,-2.6179938779914944),deltaTime) 
	end
})

addmode("v", {
	idle = function()
RightShoulder.C0=RightShoulder.C0:Lerp(cf(1.3,1,-0.3)*angles(1.2217304763960306,0,-0.5235987755982988+0.08726646259971647*sin(sine*3)),deltaTime) 
LeftShoulder.C0=LeftShoulder.C0:Lerp(cf(-1.3,1,-0.3)*angles(1.2217304763960306,0,0.5235987755982988-0.08726646259971647*sin(sine*3)),deltaTime) 
Neck.C0=Neck.C0:Lerp(cf(0,1,0)*angles(-1.3962634015954636-0.3490658503988659*sin(sine*3),0,3.141592653589793),deltaTime) 
LeftHip.C0=LeftHip.C0:Lerp(cf(-0.5,-1.4+0.2*sin(sine*3),0)*angles(-0.17453292519943295,0.17453292519943295,-0.17453292519943295),deltaTime) 
RightHip.C0=RightHip.C0:Lerp(cf(0.5,-1.4+0.2*sin(sine*3),0)*angles(0.08726646259971647,-0.2617993877991494,0.08726646259971647),deltaTime) 
RootJoint.C0=RootJoint.C0:Lerp(cf(0,0.3-0.3*sin(sine*3),0)*angles(-1.4835298641951802,0,3.0543261909900767+0.08726646259971647*sin(sine*3)),deltaTime) 
	end
})
...
RootJoint.C0=RootJoint.C0:Lerp(cf(0,-1.5,0)*angles(-1.5707963267948966,0,3.141592653589793),deltaTime) 
RightHip.C0=RightHip.C0:Lerp(cf(0.5,-2,0)*angles(1.5707963267948966,0,0.3490658503988659),deltaTime) 
LeftHip.C0=LeftHip.C0:Lerp(cf(-0.5,-2,0)*angles(1.5707963267948966,0,-0.3490658503988659),deltaTime) 
LeftShoulder.C0=LeftShoulder.C0:Lerp(cf(-1.4,0.5,-1)*angles(0.8726646259971648,0,0.3490658503988659),deltaTime) 
RightShoulder.C0=RightShoulder.C0:Lerp(cf(1.4,0.5,-1)*angles(0.8726646259971648,0,-0.3490658503988659),deltaTime) 
	end
})